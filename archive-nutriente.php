    ...
    <div class="page-layout">
      <div class="ne-sub-header ne-sub-header__nutriente">
        <div class="section-normal">
            <h1 class="ne-sub-header__title">Nutrientes</h1>
            <p class="ne-sub-header__category">Consulte a nossa lista de nutrientes</p>
        </div>
      </div>
                ...
                <?php
                    ...
                    echo '<section class="ne-aside__container">';
                        ...
                        echo '<ul class="ne-categories-list ne-nutricat">';
                            echo '<li><a class="ne-categories-list__link ne-nutricat_item ne-nutricat_item--all" href="' . esc_url(site_url('nutrientes')) . '">Todas</a></li>';
